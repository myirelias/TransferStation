...
import pickle
import json
from travel_crawl import Crawl
from travel_spider import Spider
from travel_pipe import Pipe
import travel_setting as setting
...
class Engine(object):
            ...
            while True:
                ...
                if res.get('data'):
                    ...
                    for each in reslist:
                        ...
                        if self._engine_mk_timestamp(publish) > 0.0:# float(self.maxtime.get(position, 0.0)):
    ...
    def _engine_update_news(self, news_dict):
        ...
        # if news_info.get('title'):
        self.pipe.pipe_save_db(news_info, dbname='db_xinhua_news', colname='col_travel')
        time.sleep(0.5)
